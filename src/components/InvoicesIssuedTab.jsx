...
const InvoicesIssuedTab = () => {
    ...
    const PayInvoice = async (invoice) => {
        try {
          ...
          if (response.ok) {
              await removeInvoice(invoice.id); // Usuń zamówienie po zapisaniu faktury
          } else {
                ...
                <ul className="responsive-table">
                    <li className="table-header">
                        <div className="table-header--card">
                            ...
                            <div className="col col-1 t-center">Faktura</div>
                        </div>
                    ...
                    {sortedInvoices.map(invoice => (
                        <li className="table-row" key={invoice.id}>
                            <div className="table-row--card">
                                ...
                                <div className="col col-1 t-center">
                                    <TextButtonTransparent onClick={() => PayInvoice(invoice)} content="Opłać" title="Opłać fakture"/>
                                </div>
...
export default InvoicesIssuedTab;
